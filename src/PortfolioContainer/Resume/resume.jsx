...
import { RESUME_SCREEN, GET_RESUME_SCREEN_INDEX } from './../../utilities/commonUtils'
...
const Resume = ({ id }) =>
{
    ...
    {
        return (
            RESUME_SCREEN.map((screen, i) => (
                <div key={screen.screen_name} className={`list-group-item list-group-item-action bg-orangeP text-white hover:bg-orange-400 cursor-pointer ${getHeaderOptionsClass(i)}`} onClick={() => switchScreen(i, screen)}>
